(function (global, factory) {
    ...
    */
    ...
    class IDB_Persistence_Adapter extends Persistence {
        ...
        readIndexes(event) {
            return __awaiter(this, void 0, void 0, function* () {
                const keys$1 = (yield keys(databases["indexes"])).sort((a, b) => {
        ...
        readData(event) {
            return __awaiter(this, void 0, void 0, function* () {
                const keys$1 = (yield keys(databases["data"])).sort((a, b) => {
                    return Number(a.split("__")[0]) - Number(b.split("__")[0]);
                });
                for (let i = 0; i < keys$1.length; i++) {
                    const key = keys$1[i];
        ...
        rewriteIndexes(event) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                event.on("writeLine", (data) => __awaiter(this, void 0, void 0, function* () {
                    yield set(ts(), data, databases["indexes"]);
                }));
            });
        }
        rewriteData(event) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                event.on("writeLine", (data) => __awaiter(this, void 0, void 0, function* () {
                    yield set(ts(), data, databases["data"]);
                }));
            });
        }
        appendIndex(data) {
