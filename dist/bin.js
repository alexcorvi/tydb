...
const _storage = {
    lock: function (filename) {
        return new Promise((resolve) => {
            lockfile.lock(filename, { retries: 5, retryWait: 1 }, function (err) {
                if (err)
    ...
    unlock: function (filename) {
        return new Promise((resolve) => {
            lockfile.unlock(filename, () => resolve());
        });
    },
...
class FS_Persistence_Adapter extends Persistence {
    constructor() {
        super(...arguments);
    ...
    readFileByLine(event, filename) {
        return new Promise((resolve, reject) => {
            storage
                ...
                .then(() => {
                storage.readByLine(filename, (line) => __awaiter(this, void 0, void 0, function* () {
    ...
    writeFileByLine(event, filename) {
        return new Promise((resolve, reject) => {
            storage
                ...
                .then((stream) => {
                event.on("writeLine", (line) => __awaiter(this, void 0, void 0, function* () {
                    if (line) {
                        yield storage.writeSingleLine(stream, `${line}\n`);
                    }
                }));
                event.on("end", () => __awaiter(this, void 0, void 0, function* () {
