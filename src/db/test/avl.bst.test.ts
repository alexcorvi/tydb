import BinarySearchTree from "../lib/avl/bst";
import * as customUtils from "../lib/avl/utils";
...
describe("Binary search tree", () => {
	it("Upon creation, left, right are null, key and data can be set", () => {
		...
		{
			let bst = new BinarySearchTree({ key: 6, value: "ggg" });
			assert.isUndefined(bst.left);
			assert.isUndefined(bst.right);
	...
	describe("Sanity checks", () => {
		...
		it("Can get the number of inserted keys", () => {
			const bst: any = new BinarySearchTree();
	...
	describe("Insertion", () => {
		...
		it("If uniqueness constraint is enforced, we cannot insert different data for same key", () => {
			const bst = new BinarySearchTree<number, string>({ unique: true });
		...
		it("Can insert 0 or the empty string", () => {
			let bst = new BinarySearchTree<number, string>();
			...
			assert.isUndefined(bst.right);
			{
				let bst = new BinarySearchTree<string, string>();
	...
	describe("Search", () => {
		...
		it("Can find ascending ordered data in a BST", () => {
			var bst = new BinarySearchTree<number, any>();
		...
		it("Can find descending ordered data in a BST", () => {
			const bst = new BinarySearchTree<number, any>();
			let i;
