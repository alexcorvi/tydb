...
const customUtils = __importStar(require("./customUtils"));
...
class Persistence {
    ...
    loadDatabase(callback) {
        ...
        storage_1.default.mkdirp(path_1.default.dirname(this.filename));
        storage_1.default
            .ensureDataFileIntegrity(this.filename)
            .then(() => storage_1.default.readFile(this.filename, "utf8"))
            .then((rawData) => {
            let treatedData = this.treatRawData(rawData);
            // Recreate all indexes in the datafile
            Object.keys(treatedData.indexes).forEach((key) => {
                this.db.indexes[key] = new indexes_1.default(treatedData.indexes[key]);
            });
