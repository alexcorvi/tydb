...
var customUtils = require("./customUtils"), model = require("./model"), async = require("async"), Index = require("./indexes").default, util = require("util"), _ = require("underscore"), Persistence = require("./persistence").Persistence, Cursor = require("./cursor").default;
/**
            ...
            docs.forEach(function (doc) {
                ...
                ttlIndexesFieldNames.forEach(function (i) {
                    if (doc[i] !== undefined &&
                        util.isDate(doc[i]) &&
                        Date.now() >
                            doc[i].getTime() + self.ttlIndexes[i] * 1000) {
                        valid = false;
                    }
                });
                if (valid) {
