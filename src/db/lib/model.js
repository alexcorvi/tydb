...
function deepCopy(obj, strictKeys) {
    ...
    // CHANGED
    throw new Error("Attempted to deep copy a value that is neither an array nor an object");
}
...
function createModifierFunction(modifier) {
    return function (obj, field, value) {
        ...
        if (fieldParts.length === 1) {
            ...
            modifierFunctions[modifier](obj[fieldParts[0]], fieldParts.slice(1).join("."), // CHANGED
            value);
        }
    };
}
