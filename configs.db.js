...
module.exports = {
	 ...
	 */
	databases: {
		// "mydb" will be used as a namespace for the database connection URL: (e.g. http://localhost:3000/mydb)
		mydb: {
			// "workspace/external" is the file path that the database data will be saved to
			ref: "workspace/external",
			// a model that your documents will confirm to
			model: MyModel,
